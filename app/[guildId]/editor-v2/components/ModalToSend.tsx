              ...
              <div ref={setModalContainer} className="contents">
                <Modal.Header className="flex items-center justify-between px-6 py-4 border-b border-zinc-700/40 shrink-0">
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`flex items-center gap-1.5 text-xs px-2 py-1 rounded-md ${hasErrors ? "bg-red-500/10 text-red-400" : "bg-emerald-500/10 text-emerald-400"}`}
                    >
                      {hasErrors ? (
                        <AlertCircle size={12} />
                      ) : (
                      ...
                      <span>
                        {validation.componentCount}/40 · {validation.totalChars}
                        /4000
                      </span>
                    </div>
                    ...
                    */}
                      ...
                      <div className="px-4 mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[11px] text-zinc-500 select-none whitespace-nowrap">
                            Hoje
                          </span>
                          <div className="flex-1 h-px bg-zinc-700/50" />
                        </div>
                            ...
                            onClick={() =>
                              handleSendMessage(
                                serverData?.serverConfig
                                  ?.announcementsPreviewCh ?? undefined,
                              )
                            }
                            tooltipText="Atalho"
                            kdbText="Alt + 1"
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <TextChannelSelect
                            channels={channels}
                            value={channelSend}
                            onChange={(v: string) => setChannelSend(v)}
