...
import { Button, ButtonGroup, Skeleton, Spinner } from "@heroui/react";
import { CircleAlert, Download, IdCard, UserRoundPen } from "lucide-react";
...
export default function RecordTab({ userId, guildId }: RecordTabProps) {
      ...
      <div className="container mx-auto space-y-6 pt-6 px-12 py-12 bg-[#171717] rounded-2xl">
        <div className="flex flex-col sm:flex-row print:hidden mx-auto max-w-5xl border-b h-20 border-zinc-700 mb-6 gap-6">
          <h1 className="flex items-center text-lg font-bold tracking-wide text-zinc-300 gap-2">
            <Skeleton className="h-7 w-62 bg-zinc-800 rounded-3xl" />
          </h1>
          <div className="sm:ml-auto space-x-2 pt-4 sm:pt-0 items-center flex">
            <Skeleton className="h-7 w-40 bg-zinc-800 rounded-3xl" />
          </div>
        </div>
  ...
  return (
    <div className="container mx-auto space-y-6 pt-6 px-12 py-12 bg-[#171717] rounded-2xl">
      <div className="flex flex-col sm:flex-row print:hidden mx-auto max-w-5xl border-b h-20 border-zinc-700 mb-6 gap-6">
        <h1 className="flex items-center text-lg font-bold tracking-wide text-zinc-300 gap-2">
          <IdCard /> Ficha de {member.gameName || member.userTag || member.userId}
        </h1>
        <div className="sm:ml-auto space-x-2 pt-4 sm:pt-0 items-center flex">
